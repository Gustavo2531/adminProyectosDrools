...
public class ActuadorC {
    ...
    public ActuadorC(Integer id, String nombre, String ubicacionE,String ubicacionC,boolean conectado, boolean estado,String descripcion, String tipoActuador, float consumoEnergia,String unidad, float temperatura){
         this.id = id;
         this.nombre = nombre;
        this.ubicacionE=ubicacionE;
        this.ubicacionC=ubicacionC;
